...
<div class="flex min-h-full">
		...
		<div class="mx-auto w-full max-w-sm lg:w-96">
			<div>
				...
				<p class="mt-2 text-sm text-gray-600">
					Or
					<a href="/auth/register" class="font-medium text-rose-600 hover:text-rose-500"
						>register now</a
					>
				</p>
			</div>
	...
	<div class="relative hidden w-0 flex-1 lg:block">
		<img
			...
			src="https://cdn.discordapp.com/attachments/281968307576504320/1079946769464574024/splash.webp"
			alt=""
		/>
	</div>
</div>
