<script lang="ts">
	...
	import FormError from '../../../common/form/errors/FormError.svelte';
	import FormFieldError from '../../../common/form/errors/FormFieldError.svelte';
			...
			<div>
				...
				<div class="mt-1">
					<input
						...
						class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-rose-500 focus:outline-none focus:ring-rose-500 sm:text-sm"
					/>
					<FormFieldError {errors} field="password" />
				</div>
			</div>
