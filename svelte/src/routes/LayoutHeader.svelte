...
<header class="bg-white shadow-sm lg:static lg:overflow-y-visible {isMobileMenuOpen ? 'fixed inset-0 z-40 overflow-y-auto' : '' }">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
      <div class="flex md:absolute md:inset-y-0 md:left-0 lg:static xl:col-span-2">
        <div class="flex flex-shrink-0 items-center text-rose-500">
      ...
      <div class="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
        ...
        <div class="relative ml-5 flex-shrink-0">
          ...
          <div class="{isDropdownMenuOpen ? 'transform opacity-100 scale-100' : 'transform opacity-0 scale-95'} absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
        ...
        <a href="#" class="ml-6 inline-flex items-center rounded-md border border-transparent bg-rose-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2">Upload</a>
      </div>
    </div>
  </div>

  <!-- Mobile menu, show/hide based on menu state. -->
  <nav class="{isMobileMenuOpen ? '' : 'hidden' } lg:hidden" aria-label="Global">
    ...
    <div class="mx-auto mt-6 max-w-3xl px-4 sm:px-6">
      <a href="#" class="flex w-full items-center justify-center rounded-md border border-transparent bg-rose-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-rose-700">Upload</a>
    </div>
  </nav>
</header>