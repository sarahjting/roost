...
<form class="divide-y-slate-200 mt-6 space-y-8 divide-y">
	<div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
		...
		<div class="sm:col-span-3">
			...
			<input
				...
				class="mt-1 block w-full rounded-md border-slate-300 text-slate-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
			/>
		</div>
		...
		<div class="sm:col-span-6">
			...
			<div class="mt-1 flex rounded-md shadow-sm">
				<span
					class="inline-flex items-center rounded-l-md border border-r-0 border-slate-300 bg-slate-50 px-3 text-slate-500 sm:text-sm"
					>workcation.com/</span
				>
				<input
					type="text"
					...
					value="lisamarie"
					class="block w-full min-w-0 flex-1 rounded-none rounded-r-md border-slate-300 text-slate-900 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
				/>
			</div>
		</div>
		...
		<div class="sm:col-span-6">
			...
			<div class="mt-1 flex items-center">
				...
				<div class="ml-4 flex">
					<div
						class="relative flex cursor-pointer items-center rounded-md border border-slate-300 bg-white py-2 px-3 shadow-sm focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 focus-within:ring-offset-slate-50 hover:bg-slate-50"
					>
						<label
							for="user-photo"
					...
					<button
						type="button"
						class="ml-3 rounded-md border border-transparent bg-transparent py-2 px-3 text-sm font-medium text-slate-900 hover:text-slate-700 focus:border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-50"
						>Remove</button
					>
				</div>
			</div>
	...
	<div class="grid grid-cols-1 gap-y-6 pt-8 sm:grid-cols-6 sm:gap-x-6">
		...
		<div class="sm:col-span-3">
			<label for="email-address" class="block text-sm font-medium text-slate-900"
				>Email address</label
			>
			<input
				type="text"
		...
		<p class="text-sm text-slate-500 sm:col-span-6">
			This account was created on <time datetime="2017-01-05T20:35:40"
				>January 5, 2017, 8:35:40 PM</time
			>.
		</p>
	</div>
	...
	<div class="flex justify-end pt-8">
		<button
			type="button"
			class="rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-slate-900 shadow-sm hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
			>Cancel</button
		>
		<button
			type="submit"
